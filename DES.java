...
public class DES {
    ...
    private static String[] intermediates = new String[67];
    ...
    private static String byteArrayToBits(byte[] byteArray) {
        String bitString = "";
    ...
    private static int compareBitStrings(String original, String encoded) {
        int count = 0;
    ...
    public static void main(String[] args) {
        ...
        try
        {
            String textClar = "DES Alg";
            String updated = "EES Alg";
            //DES
            String k = "5qw8sd4h";
            ...
            String[] updatedString = d.encryptAndReturnIntermediatesArray(updated.getBytes(), k.getBytes());
